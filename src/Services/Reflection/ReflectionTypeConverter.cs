...
namespace Bau.Libraries.LibHelper.Services.Reflection;
...
public class ReflectionTypeConverter
{
	...
	{
		return value is null ? string.Empty : System.Convert.ToString(value, System.Globalization.CultureInfo.InvariantCulture);
	}
	...
	/// </summary>
	private bool IsDateTime(object source) => source is DateTime;
