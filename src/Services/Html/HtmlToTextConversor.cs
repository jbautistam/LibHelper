...
namespace Bau.Libraries.LibHelper.Services.Html
{
	/// <summary>
	...
	public class HtmlToTextConversor
	{
		...
		/// </summary>
		private string Replace(string source, string regEx, string newString)
		{ 
			if (!string.IsNullOrEmpty(source))
				return Regex.Replace(source, regEx, newString, RegexOptions.IgnoreCase);
			else
				return source;
		}
